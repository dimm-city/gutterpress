...
**Status (2026-08-22):** PR #154 was closed without landing; the editing
surface that shipped instead is the one in PR #158, which keeps the preview
and the editor as separate surfaces. This document is kept because the
reasoning in it — what the galley approach bought, where it broke, and what
would have to be true for it to work — outlives the branch it describes.

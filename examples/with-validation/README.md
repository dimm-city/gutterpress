...
[Docker image](https://github.com/dimm-city/gutterpress/blob/main/docs/docker.md). Rendering any PDF also needs a
Chromium-based browser (see [System Setup](https://github.com/dimm-city/gutterpress/blob/main/examples/gutterpress-user-guide/07-system-setup.md)).

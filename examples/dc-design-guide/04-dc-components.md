@chapter #ch-dc-components .dc-components ch="1"
...
|----------|-------|--------|
| `.dc-columns` | 3.5 in | Two cards per visual row (default for specialty sections) |
| `.dense` | 3.5 in | Deprecated alias for `.dc-columns` — use `.dc-columns` |
| `.dc-rows` | Full column width | One card per row, stacked vertically |
...
```html
<div class="dc-specialty augmerc dc-columns">

 ...
 */
export declare function createServerState(inputPath: string, tempDir: string, assetsSourceDir: string, config: ResolvedConfig, options: PreviewServerOptions): ServerState;

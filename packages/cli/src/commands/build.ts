...
const commandArgs = {
  ...
  "allow-shrink": { type: "boolean", description: "Build even when content is wider than the page content box (Chromium then prints the WHOLE book scaled down; offenders are reported as warnings)" },

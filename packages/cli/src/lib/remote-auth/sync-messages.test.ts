 ...
 *
 * The viewer's Advanced Setup dialog sanitizes every displayed message with
...
test("no sync message contains a URL-shaped token (the viewer sanitizer would redact it)", () => {

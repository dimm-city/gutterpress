 ...
 *      from the published @vscode/markdown-editor@0.0.2-87 tarball, BEFORE
  ...
  if (failures.length > 0) {
    ...
    console.error(
      "\n[verify-vendored] An 'unpatched' mismatch means a vendored file no longer matches the published " +
        "@vscode/markdown-editor@0.0.2-87 tarball. A 'patched' mismatch means dist/index.js or dist/index.d.ts " +

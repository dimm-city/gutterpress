<script lang="ts">
   ...
   * machinery, and `$lib/files/files-capability` calls live in
   * `DesignSectionController` (passed as the single `controller` prop — this was the first section to get the

  ...
  {:else if data}
    ...
    <section class="getting-started">
      ...
      <ol class="steps">
        ...
        <li><strong>Edit your pages</strong> — click <em>Edit</em> (or press {modKey}+E) to open the markdown editor beside the preview. Your changes save automatically, and {modKey}+S or the Save button saves immediately. To save only when you choose, turn off <em>Save edits automatically</em> in Settings &gt; Saving.</li>

<script lang="ts">
  // Inline Lucide icons (MIT-licensed, https://lucide.dev). We inline a tiny
  // hand-picked subset rather than depending on a 1300-icon SDK — the desktop
  // toolbar only uses ~10 glyphs.
  //
  // To add an icon: copy the path data from https://lucide.dev/icons/<name>
  // and add a new entry below. Lucide SVGs are uniformly 24×24, stroke 2.
  ...
  const ICONS: Record<IconName, string> = {
    ...
    "save":
      '<path d="M15.2 3a2 2 0 0 1 1.4.6l3.8 3.8a2 2 0 0 1 .6 1.4V19a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2V5a2 2 0 0 1 2-2z"/><path d="M17 21v-7H7v7"/><path d="M7 3v5h8"/>',
    "refresh-cw":
    ...
    // Editor toolbar icons (#31) — Lucide MIT
    "bold":

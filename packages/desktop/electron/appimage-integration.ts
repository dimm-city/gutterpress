...
// three per-user files that make the packaged desktop a first-class desktop
 ...
 * desktop resolves initial and second-instance argv to a manifest-bearing
 * Gutterpress project. `StartupWMClass` matches package.json's `desktopName`-

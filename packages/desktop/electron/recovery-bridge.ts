 ...
 *
 * Uses the real `gutterpress` declarations for the recovery surface.
 */
...
type LibForContext = Pick<typeof import("gutterpress"), "buildRecoveryContext">;
...
// gutterpress barrel as `classifyFromHealth`) — ONE ordering and ONE

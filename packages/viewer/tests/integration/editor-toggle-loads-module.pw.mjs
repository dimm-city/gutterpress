...
bookDir = mkdtempSync(join(tmpdir(), "pmd-editortoggle-"));
...
fakeHome = mkdtempSync(join(tmpdir(), "pmd-editortoggle-home-"));
// Use --user-data-dir to point Electron at a throwaway userData directory.
// Write viewer-prefs.json there with the fixture path and Files tab (NOT toc)

 ...
 *
 * CodeMirror completion source for print-md's CORE `@marker` family — the
 ...
 * for print-md's own layout syntax (UX finding M26 — CSS authors previously
...
export const markerCompletions: readonly MarkerCompletion[] = [
  ...
  {
    label: "@continue",
    detail: "Close the current @section and reopen a matching one, marked .pmd-continued",
    apply: "@continue",
  },
  {
    label: "@page-break",

...
// viewer-prefs.json. They are intentionally side-effect-free (no electron,
 ...
 * `viewMode` in ViewerPrefs, prefs-store.ts) has been deleted outright.
 */
...
// `ViewerPrefs` no longer has top-level `currentPage`/`viewMode` fields to

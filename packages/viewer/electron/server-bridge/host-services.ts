 ...
 * separate `__printMd*Hooks__` globalThis keys (`create-host-bridge.ts`'s
 ...
 * default.
 *
 * This module collapses all of it to ONE globalThis key (`__printMdHost__`)
 ...
 *
 * `LibModule` below is the REAL `@dimm-city/print-md` module type (matching
...
/** The real `@dimm-city/print-md` module shape — see the module doc above. */
...
const bridge = createHostBridge<HostServices>("__printMdHost__");
